    ...
    <div className={styles.container}>
      <div className={styles.container__data}>
        <div className={styles.data__title}>
          <h1>Aparta Estudio</h1>
          <h2>Capacidad para 4 personas</h2>
          <p>
            Espectacular aparta estudio con una capacidad de 4 personas, las
            cuales ocuparían dos camas dobles, cuenta con cocina totalmente
            dotada, al igual que un baño con todos sus implementos, esta
            habitación es ideal para familias o grupos de amigos que viajan
            juntos, cuenta con televisor SmartTV y TDT.
          </p>
        </div>
        <div className={styles.data__carousel}>
          <div className="sandbox">
            <section className="sandbox__carousel">
              <Carousel
                foto1="apartaEstudio.jpg"
                foto2="apartaEstudio2.jpg"
                foto3="apartaEstudio3.jpg"
                foto4="apartaEstudio4.jpg"
              />
            </section>
          </div>
        </div>
      ...
      <div className={styles.data__roomInfo}>
        ...
        <div className={styles.roomInfo__room}>
          <h2>Equipamiento del Aparta Estudio:</h2>
          <p> Ropa de Cama</p>
          <p>Servicio de despertador</p>
          <p>Toallas</p>
          <p>Cocina</p>
          <p>Barra de Comedor</p>
          <p>Televisor Smart TV</p>
          <p>Ollas y Utencilios de Cocina</p>
          <p>Nevera</p>
          <p>Michroondas</p>
          <p>Cubiertos</p>
          <p>Recepción 24h</p>
